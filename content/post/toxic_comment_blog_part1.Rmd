...
The test data recall score improved by only 4% reaching 58%. In the next post, we will try to improve this score by using feature engineering and Logistic Regression.
